...
class ApiService {
  ...
  static Future<Map<String, dynamic>> getTeamLeaders(int teamId, {int season = 2026}) async {
    final res = await _dio.get('/teams/$teamId/leaders', queryParameters: {'season': season});
    return res.data;
  }

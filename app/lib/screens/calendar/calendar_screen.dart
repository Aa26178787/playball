    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _visitStatChip('$losses패', Colors.red),
          if (draws > 0) ...[
            const SizedBox(width: 4),
            _visitStatChip('$draws무', Colors.grey),
          ],
          const Spacer(),
          Text('$pct%',
              style: TextStyle(
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        Text('홈', style: TextStyle(fontSize: 11, color: Colors.grey[600])),
                      ],
                    ),
                  ),
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(awayTeam,
                            style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                            textAlign: TextAlign.center),
                        Text('원정', style: TextStyle(fontSize: 11, color: Colors.grey[600])),
                      ],
                    ),
                  ),
                ],
